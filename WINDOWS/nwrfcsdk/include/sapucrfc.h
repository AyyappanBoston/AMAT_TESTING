/* @(#) $Id: //bas/753_REL/src/include/sapucrfc.h#3 $ SAP*/
/* CCQ_CCU_FILE_OFF */ /* CCQ_COV_FILE_OFF */ /* CCQ_IPV6_SUPPORT_FILE_OK */ /* CCQ_USE_TIME_T_FILE_OK */
#ifndef SAPUCRFC_H
#define SAPUCRFC_H "$Id: //bas/753_REL/src/include/sapucrfc.h#3 $"
 ...
 *     #define SAP_IDENT "@(#) $Id: //bas/753_REL/src/include/sapucrfc.h#3 $"
 ...
 *     SAP_IDENTN(name,"@(#) $Id: //bas/753_REL/src/include/sapucrfc.h#3 $")
...
#if ((!defined(SAPonHP_UX)) || defined(_MODE_T)) && !defined(SAPonNT)
...
SAP_U16_PROTOTYPE_MODE_T(mkdir)
   ...
   */
  externC int SAP_mkstemps(SAP_UTF16* tmpl, int suffix_len);
 ...
 *----------------------------------------------------------------------------*/
#if defined(SAPonAIX) && defined(UNICODE_DEBUG)
